...
Install `Music21 <http://mit.edu/music21/doc/html/install.html#install>`_ and `MATPLOTLIB <http://matplotlib.sourceforge.net/>`_, then download the `Figure Divinator source code <https://github.com/DDMAL/figured-bass-extractor>`_.
